...
import * as styles from "./CustomAreaDetail.module.scss";

// @ts-ignore
import IslandCopy from "../IslandCopy/IslandCopy";

interface ICustomAreaDetailProps {
 ...
 * @return {void}
 */
const CustomAreaDetail = ({
  properties,
  visibleLayer,
}: ICustomAreaDetailProps) => {
  const intl = useIntl();
    ...
    <aside className={styles.areaDetailContainer} data-cy={"aside"}>
      ...
      <div className={styles.categorization}>
        ...
        <div className={styles.communityOfFocus}>
          {isBurdenLayer && (
            <CustomTractPrioritization threshold={threshold} />
          )}
        </div>
      </div>
